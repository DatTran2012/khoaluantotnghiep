...
namespace ThucAnNhanh.ReportExcel
{
    public class ExcelExport
    {
        ...
        string tongSo;
        public static string tongtienNhap;
       ...
       // public const string T_DanhMucKhoa = "DanhMucKhoa";
        public const string T_PhieuNhap = "ChiTietPhieuNhap";
        #endregion
        ...
        private void BuildReplacerCurrentDate(ref Dictionary<string, string> pReplacer)
        {
            if (pReplacer != null)
            {
                ...
                pReplacer.Add("%NgayNhap", ngay);
                pReplacer.Add("%TinhTrangNhap", "Đã nhập");
                pReplacer.Add("%TenNV", nv.layTenNV(FrmMain.TenDN));
                pReplacer.Add("%TenNV1", nv.layTenNV(FrmMain.TenDN));
                pReplacer.Add("%TongCong", tongSo);
                pReplacer.Add("%TongTienNhap", tongtienNhap);
        ...
        private MemoryStream GetTemplateStream(string viewName)
        {
            ...
            switch (viewName)
            {
                ...
                case T_PhieuNhap:
                    ...
                    arrByte = File.ReadAllBytes("ChiTietPhieuNhap.xlsx").ToArray();
                    break;
                #endregion
            }
            // Get stream
        ...
        //public bool ExportKhoa(List<ChiTietPhieuNhap> dataSource, ref string fileName, bool isPrintPreview)
        //{
        //    // Check if data is null
        ...
        //    return OutSimpleReport(dataSource, replacer, "ChiTietPhieuNhap", isPrintPreview, ref fileName);
        //}
        public bool ExportKhoa(List<ChiTietPhieuNhap> dataSource, ref string fileName, bool isPrintPreview)
        {
            // Check if data is null
            ...
            tongSo = dataSource.Count.ToString();
